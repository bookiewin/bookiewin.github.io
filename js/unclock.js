...
async function InitPage() {isweb3 = await initWeb3();
    if (!isweb3) {
...
$('#maskP').hide()
$('#unlockWallet').click(function () {$('#maskP').show()})
$('#cancle').click(function () {$('#maskP').hide()})
$('.js-unclock').click(function() {window.location.reload();})
// listen
